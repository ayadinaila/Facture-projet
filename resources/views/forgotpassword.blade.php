...
<body class="main-facture" style="font-family :  'Poppins', sans empattement !important; ">
    ...
    <div class="login-page" >
        ...
        <div class="login-form" style="top:70px;">
            ...
            <div class="signin" >
                <h1 style="font-size:30px !important; font-weight:bold; margin-top:18px !important; ">Reset Password</h1> <br>
            ...
            <form action="{{ route('password.update') }}" method="POST">
                ...
                <div class="password form">
                    ...
                    <i class="bi bi-eye" onclick="shownewpassword()"></i>
                </div>

                <div class="password form">

                    <i class='bx bx-lock-alt'></i>
                    <input type="password" id="confirmpassword" name="password_confirmation" placeholder="Confirm Password" required style="width: 300px !important;">
                    <i class="bi bi-eye" onclick="showconfirmpassword()"></i>
                </div>
